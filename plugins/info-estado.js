...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Emerson
  ${tradutor.texto1[2]} +51933114056
  ...
  const Message = {
    document: { url: `https://github.com/Emerson` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://github.com/Emerson",
        mediaType: 2,
        previewType: "pdf",
        title: "𝐄𝐦𝐫𝐳𝐤𝟏𝟕",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://github.com/Emerson",
      },
    },
    caption: info,
    footer: wm,
